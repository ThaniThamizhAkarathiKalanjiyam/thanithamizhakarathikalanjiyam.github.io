...
*   4\. "{{ page.title }}/" என்னும் சொல்லை தேடுங்கள். 
{% if page.is_dictionary == 1 %}
	* 4\.1\. "{{ page.title }}" **அகராதி** ஆதலால் அகராதி பற்றிய குறிப்பு மட்டும் வரும், பொருள் காண வேண்டிய சொல்லை தேடுபட்டியில் தேடினால் அதற்குரிய பொருள் வரும்.
{% else %}
	* 4\.1\. "{{ page.title }}" **நூல்** ஆதலால் பொருளடக்கம் வரும். நூலை படிக்க ஆரம்பியுங்கள். 
{% endif %}

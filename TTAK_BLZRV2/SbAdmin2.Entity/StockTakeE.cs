...
namespace TTAK_BLZRV2.Entity
{
    ...
    public class StockTakeE
    {
        ...
        public string baseuom_cod { get; set; }
        public List<UomE> uom { get; set; }
        public bool withuom_bool { get; set; }
        public string itemjnltemplatename_cod { get; set; }
        public string itemjnlbatchname_cod { get; set; }
